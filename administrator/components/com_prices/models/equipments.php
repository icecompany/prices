...
class PricesModelEquipments extends ListModel
{
    public function __construct($config = array())
    {
        ...
        if ($config['export']) $this->export = true;
    }
    ...
    public function getItems()
    {
        ...
        foreach ($items as $item) {
            ...
            $arr['type'] = JText::sprintf("COM_PRICES_FORM_EQUIPMENT_TYPE_{$type}");
            $url = JRoute::_("index.php?option={$this->option}&amp;task=equipment.edit&amp;id={$item->id}");

...
// Access check.
if (!Factory::getUser()->authorise('core.manage', 'com_prices'))
{
...
require_once JPATH_COMPONENT_ADMINISTRATOR . '/helpers/prices.php';

// Execute the task
$controller = BaseController::getInstance('prices');

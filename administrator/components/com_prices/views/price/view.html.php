...
class PricesViewPrice extends HtmlView {
    ...
    protected function setDocument() {
        $title = ($this->item->id !== null) ? JText::sprintf('COM_PRICES_TITLE_PRICE_EDIT', $this->item->title) : JText::sprintf('COM_PRICES_TITLE_PRICE_ADD');

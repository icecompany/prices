...
HTMLHelper::_('script', 'com_prices/section.js', array('version' => 'auto', 'relative' => true));
?>
<form action="<?php echo PricesHelper::getActionUrl(); ?>"
    ...
    <div class="row-fluid">
        <div class="span12 form-horizontal">
            ...
            <div class="tab-content">
                <?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::sprintf('COM_PRICES_TITLE_TAB_GENERAL')); ?>
                <div class="row-fluid">
                    <div class="span6">

...
class PricesViewUnit extends HtmlView {
    ...
    protected function setDocument() {
        $title = ($this->item->id !== null) ? JText::sprintf('COM_PRICES_TITLE_UNIT_EDIT', $this->item->title) : JText::sprintf('COM_PRICES_TITLE_UNIT_ADD');
